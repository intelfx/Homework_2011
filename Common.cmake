...
SET(FX_OPT_ARGS		"${FX_OPT_ARGS} -mfpmath=both -march=native")
SET(FX_DBG_ARGS		"")
SET(FX_LD_FLAGS		"-O3 -Wl,-O1,--sort-common,--as-needed,-z,relro,--hash-style=gnu")
# ----
...
SET(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} ${FX_OPT_ARGS}")
...
SET(CMAKE_EXE_LINKER_FLAGS_RELEASE "${FX_OPT_ARGS}")
SET(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} ${FX_LD_FLAGS}")
SET(CMAKE_SHARED_LINKER_FLAGS_RELEASE "${FX_OPT_ARGS}")
SET(CMAKE_MODULE_LINKER_FLAGS "${CMAKE_MODULE_LINKER_FLAGS} ${FX_LD_FLAGS}")
SET(CMAKE_MODULE_LINKER_FLAGS_RELEASE "${FX_OPT_ARGS}")
